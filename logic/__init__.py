...
class LogicFrame:
    def __init__(self, file=None):
        ...
        self.ticker(lambda:(lambda f:(self.ui.load(f) if f!='Show' else ...) or (self.MainWindow.activateWindow() or self.MainWindow.showNormal()) if f else ...)(open('res/running').read().split('\n')[1]) or open('res/running', 'w').write('True\n'), 500)
